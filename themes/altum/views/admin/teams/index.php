            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-end">
                        <?= include_view(THEME_PATH . 'views/admin/teams/admin_team_dropdown_button.php', ['id' => $row->team_id]) ?>
                    </div>
                </td>
            </tr>
        <?php endforeach ?>
...
<?php \Altum\Event::add_content(include_view(THEME_PATH . 'views/admin/teams/team_delete_modal.php'), 'modals'); ?>
