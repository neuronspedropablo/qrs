...
<div>
    ...
    <div class="form-group">
        ...
        <?php endif ?>
        <input id="logo_light" type="file" name="logo_light" accept="<?= \Altum\Uploads::get_whitelisted_file_extensions_accept('logo_light') ?>" class="form-control-file" />
    ...
    <div class="form-group">
        ...
        <?php endif ?>
        <input id="logo_dark" type="file" name="logo_dark" accept="<?= \Altum\Uploads::get_whitelisted_file_extensions_accept('logo_dark') ?>" class="form-control-file" />
    ...
    <div class="form-group">
        ...
        <?php endif ?>
        <input id="logo_email" type="file" name="logo_email" accept="<?= \Altum\Uploads::get_whitelisted_file_extensions_accept('logo_email') ?>" class="form-control-file" />
    ...
    <div class="form-group">
        ...
        <?php if(!empty(settings()->main->opengraph)): ?>
            <div class="m-1">
                <img src="<?= UPLOADS_FULL_URL . 'opengraph/' . settings()->main->opengraph ?>" class="img-fluid" style="max-height: 5rem;height: 5rem;" />
            </div>
            <div class="custom-control custom-checkbox my-2">
