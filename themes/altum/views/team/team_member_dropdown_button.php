...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        ...
        <a href="#" data-toggle="modal" data-target="#team_member_delete_modal" data-team-member-id="<?= $data->id ?>" class="dropdown-item"><i class="fa fa-fw fa-sm fa-trash-alt mr-2"></i> <?= l('global.delete') ?></a>
    </div>
</div>
