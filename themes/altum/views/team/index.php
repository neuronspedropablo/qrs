...
<div class="container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-xl-auto d-flex">
            ...
            <div class="ml-3">
                <?= include_view(THEME_PATH . 'views/team/team_dropdown_button.php', ['id' => $data->team->team_id]) ?>
            </div>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-end">
                                <?= include_view(THEME_PATH . 'views/team/team_member_dropdown_button.php', ['id' => $row->team_member_id]) ?>
                            </div>
                        </td>
                    </tr>
                <?php endforeach ?>
...
<?php \Altum\Event::add_content(include_view(THEME_PATH . 'views/team/team_delete_modal.php'), 'modals'); ?>
<?php \Altum\Event::add_content(include_view(THEME_PATH . 'views/team/team_member_delete_modal.php'), 'modals'); ?>
