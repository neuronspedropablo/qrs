                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="image" name="image" accept=".png, .jpg, .jpeg, .svg, .webp" class="form-control-file <?= \Altum\Alerts::has_field_errors('image') ? 'is-invalid' : null ?>" required="required" />
...
<script>
    ...
    image.addEventListener('change', event => {
        ...
        QrScanner.scanImage(file, { returnDetailedScanResult: true })
            ...
            .catch(error => {
                document.querySelector('#result').value = <?= json_encode(l('qr_reader.result.no_data')) ?>;
            });
    });
</script>
