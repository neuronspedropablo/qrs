...
class Qr extends Controller {
    ...
    public function index() {
        ...
        if($type) {
            ...
            if($type == 'url' && Authentication::check()) {
                /* Existing links */
            ...
            $view = new \Altum\Views\View('qr/partials/' . $type . '_form', (array) $this);
            $this->add_view_content('qr_form', $view->run($data));

            $view = new \Altum\Views\View('qr/partials/' . $type . '_content', (array) $this);
